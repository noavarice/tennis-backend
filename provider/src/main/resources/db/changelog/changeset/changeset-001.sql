CREATE TABLE ss.countries(
  country_id INTEGER NOT NULL PRIMARY KEY,
  code CHAR(2) NOT NULL,
  name VARCHAR(100) NOT NULL
);

INSERT INTO ss.countries (country_id, code, name) VALUES
  (1, 'AF', 'Afghanistan'),
  (2, 'AL', 'Albania'),
  (3, 'DZ', 'Algeria'),
  (4, 'AS', 'American Samoa'),
...
CREATE SEQUENCE ss.players_seq
  MINVALUE 1
  CYCLE;

CREATE TABLE ss.players(
  player_id INTEGER NOT NULL PRIMARY KEY DEFAULT NEXTVAL('ss.players_seq'),
  first_name VARCHAR(50) NOT NULL,
  last_name VARCHAR(50) NOT NULL,
  country_id INTEGER NOT NULL,
  male BOOLEAN NOT NULL,
  CONSTRAINT players_country_fk
    FOREIGN KEY(country_id)
    REFERENCES ss.countries(country_id)
);
